...
plt.savefig('C:/Users/DELL/Desktop/deepceutix/backend/deepceutix_data-generator_backend/temp/1758351000319/plot.png', dpi=150, bbox_inches='tight')
...
try:
    ...
    if data_to_extract:
        with open('C:/Users/DELL/Desktop/deepceutix/backend/deepceutix_data-generator_backend/temp/1758351000319/data.json', 'w', encoding='utf-8') as f:
