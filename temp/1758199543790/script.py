...
# 4. Display the plot
plt.savefig('C:/Users/DELL/Desktop/deepceutix/backend/deepceutix_data-generator_backend/temp/1758199543790/plot.png', dpi=150, bbox_inches='tight')
...
print("---------------------------")
print("Wavenumber (cm^-1) | Assignment")
print("---------------------------")
...
try:
    ...
    if data_to_extract:
        with open('C:/Users/DELL/Desktop/deepceutix/backend/deepceutix_data-generator_backend/temp/1758199543790/data.json', 'w', encoding='utf-8') as f:
