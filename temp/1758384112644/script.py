...
javascript
   const jsonData = JSON.parse(yourJsonString); // yourJsonString contains the JSON above
...
try:
    ...
    if data_to_extract:
        with open('C:/Users/DELL/Desktop/deepceutix/backend/deepceutix_data-generator_backend/temp/1758384112644/data.json', 'w', encoding='utf-8') as f:
