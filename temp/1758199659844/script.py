...
# 2. Create y values as x squared
y = x**2

# 3. Plot the data with labels
...
# 4. Show the plot
plt.savefig('C:/Users/DELL/Desktop/deepceutix/backend/deepceutix_data-generator_backend/temp/1758199659844/plot.png', dpi=150, bbox_inches='tight')
...
try:
    ...
    if data_to_extract:
        with open('C:/Users/DELL/Desktop/deepceutix/backend/deepceutix_data-generator_backend/temp/1758199659844/data.json', 'w', encoding='utf-8') as f:
