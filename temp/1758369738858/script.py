...
markdown
| Component | Glass Transition Temp. ( degreesC)| Melting / Decomposition Temp. ( degreesC) | Degradation Onset Temp. ( degreesC) | Full Degradation Temp. ( degreesC) |
|-----------|----------------------------|------------------------------------|-----------------------------|-----------------------------|
| Paracetamol| -                           | 169                                | 180                         | 350                         |
| PLGA      | 45                          | -                                  | 100                         | 270                         |
...
try:
    ...
    if data_to_extract:
        with open('C:/Users/DELL/Desktop/deepceutix/backend/deepceutix_data-generator_backend/temp/1758369738858/data.json', 'w', encoding='utf-8') as f:
